...
class PaddleWebhookHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        if account_id and raw_status == "active":
            if not has_credit_source(int(account_id), "first_paid_subscription"):
                grant_bonus_month(int(account_id), source="first_paid_subscription")
